// UJI PENGAMBILAN POTONGAN v3 (Item 90 Tahap B, 2026-09-17) — opsi { rpc: 'hybrid' } memanggil match_documents_hybrid
...
//   await (await import('/@fs/D:/SLAMET/other/mamet os ecosystem/frontend/node_modules/.uji-rag/uji-pengambilan-v3.js')).uji({ rpc: 'hybrid' })
...
export async function uji({ ulang = 1, hanya = null, rpc = 'vektor' } = {}) {
  ...
  console.log(`[UJI-AMBIL] versi skrip 3 — RPC: ${rpc === 'hybrid' ? 'match_documents_hybrid' : 'match_documents'}`);
