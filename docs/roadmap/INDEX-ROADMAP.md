...
|---|---|---|
| 90 Pengambilan potongan RAG | 📝 **Tahap A berikutnya** (set uji pengambilan potongan); utang lama U1–U10 | [`ROADMAP-PENGAMBILAN-POTONGAN-RAG.md`](./ROADMAP-PENGAMBILAN-POTONGAN-RAG.md) |
...
| 33, 48, 49, 50 Temuan audit tanpa rancangan | ⏳ T1 izin tool Lite · T2 dasbor yatim · T3 rute mati backend · T4 `match_documents` ke `anon` | [`ROADMAP-TEMUAN-TERBUKA.md`](./ROADMAP-TEMUAN-TERBUKA.md) |
...
| `ROADMAP-TEMUAN-TERBUKA.md` | ⏳ T1–T4 | temuan audit tanpa rancangan sendiri |
...
90. 📝 Pengambilan Potongan RAG — Diukur Dulu, Pola Standar Hanya Bila Cocok (2026-09-17) — [rancangan](./ROADMAP-PENGAMBILAN-POTONGAN-RAG.md) · [log](../project-memory/changelog/2026-09-17-utang-lama-rag-dan-kode-mati.md)
