...
76. **Tabel DOCX Dibaca sebagai Tabel, dan Riset Jalur PDF untuk RAG (2026-09-14):**
    ...
    - **(b) Jalur PDF — detektor + OCR (commit `4604ccf`, diperbaiki `de75807`, 14 September 2026):**
      ...
      - **Status:** ✅ **Terbukti live di `npm run desktop`.** Di Vercel: mametlite memuat kode + pdf-lib terbundel; mamet-ecosystem menunggu deploy perbaikan `pdf-lib`. Unggahan OCR di web dan OCR paralel belum diuji live. Detail:
    ...
    - **Keterbatasan / belum dikerjakan:**
      ...
      - Jalur PDF: detektor, pemisah halaman (`pdf-lib`), dan mistral-ocr + pembersih terpasang dan terbukti live (Item 76b, `de75807`). OCR paralel sudah di kode tetapi belum diuji live. Yang masih belum: tampilan biaya unggah persisten (ledger), buku penuh sekali kirim, uji mutu jawaban, pemeriksaan salah baca kata OCR, dan unggah ulang Operator Handbook.
