...
|---|---|---|
| 92 Data tabel rekonsiliasi ASN | 📝 Tahap 1 ✅ (pembaca + pratinjau Excel di Research App, uji 53 berkas lulus); Tahap 2 (simpan + versi) menunggu aba-aba | [`ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md`](./ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md) |
...
|---|---|---|
| `ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md` | 📝 Item 92 (Tahap 1 ✅) | xlsx ASN → baris data, pratinjau Owner, hitung/saring oleh kode (bukan RAG) |
...
92. 📝 Data Tabel Rekonsiliasi ASN — Hitung & Saring oleh Kode, Bukan RAG (2026-09-21) — [rancangan](./ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md) · [log Tahap 1](../project-memory/changelog/2026-09-21-data-tabel-asn-tahap1-pembaca-pratinjau.md)
