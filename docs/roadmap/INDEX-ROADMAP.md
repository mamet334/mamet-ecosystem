...
| 89 Konteks potongan RAG | ✅ live (Tahap C Item 90); sisa: 23 potongan bercampur buku penuh (menunggu keputusan 3 Item 88) | [`ROADMAP-KONTEKS-POTONGAN-RAG.md`](./ROADMAP-KONTEKS-POTONGAN-RAG.md) |
| 88 Tabel centang PDF (+ sisa 86 OCR massal) | 🟡 Tahap 1–3 ✅ (Q1 VERIFIED live); **keputusan 3 belum** (buku penuh + OCR massal) | [`ROADMAP-TABEL-CENTANG-PDF.md`](./ROADMAP-TABEL-CENTANG-PDF.md) |
...
| 33, 48, 49, 50, 91 Temuan audit tanpa rancangan | ⏳ T1 izin tool Lite · T2 dasbor yatim · T3 rute mati backend · T4 `match_documents` ke `anon` · T6 `verification_audit_logs.metadata` tak ada (400) · T7 ✅ kunci API di `agent_logs` (sisa: Owner ganti kunci) | [`ROADMAP-TEMUAN-TERBUKA.md`](./ROADMAP-TEMUAN-TERBUKA.md) |
...
| `ROADMAP-TEMUAN-TERBUKA.md` | ⏳ T1–T4, T6 (T5, T7 ✅) | temuan audit tanpa rancangan sendiri |
