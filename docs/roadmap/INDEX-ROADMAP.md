...
|---|---|---|
| 92 Data tabel rekonsiliasi ASN | 📋 rancangan terdaftar; pengukuran 53 xlsx ✅ (0 gagal, 48/48 JUMLAH cocok); Tahap 1 menunggu aba-aba | [`ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md`](./ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md) |
...
|---|---|---|
| `ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md` | 📋 Item 92 | xlsx ASN → baris data, pratinjau Owner, hitung/saring oleh kode (bukan RAG) |
...
92. 📋 Data Tabel Rekonsiliasi ASN — Hitung & Saring oleh Kode, Bukan RAG (2026-09-21) — [rancangan](./ROADMAP-DATA-TABEL-REKONSILIASI-ASN.md)
