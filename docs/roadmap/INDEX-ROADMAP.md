...
27. **Bug Core Protection Layer — 5 dari 12 Pattern Immutable Tidak Pernah Cocok — [`2026-09-09-fix-core-protection-layer-path-matching-bug.md`](../project-memory/changelog/2026-09-09-fix-core-protection-layer-path-matching-bug.md):**
    ...
    - **Ditemukan bersamaan, belum diperbaiki (item terpisah):** `engineer.js` `_loadStaticKnowledge()` mencoba membaca 4 path yang tidak pernah ada, dan daftar file statis Engineer **tidak memuat** `24_ANTI_HALLUCINATION_PROTOCOL.md` s/d `27_DECISION_HEURISTICS.md` — Engineer produksi belum pernah membaca Anti-Hallucination Protocol. Menunggu keputusan Owner.
