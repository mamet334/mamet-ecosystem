...
**Dihapus (2026-09-09, lihat ADR-0018):** `docs/project-memory/MAEF V2.md`, `docs/project-memory/MAEF V3.md`, `docs/project-memory/MAMET AI VISION CONSTITUTION V2.md` — ketiganya digantikan `constitution/00_CONSTITUTION.md` v3.0. Konsep unik (Two-Brain Model, Self Engineering Lifecycle → `constitution/07_ENGINEERING_SYSTEM.md`; Engineering Confidence → `constitution/16_ENGINEERING_METRICS_SYSTEM.md`) sudah diserap sebelum file dihapus. Isi lengkap tetap tertelusuri lewat `git log` bila diperlukan — tidak disimpan sebagai file hidup agar jumlah dokumen governance tetap ramping.
